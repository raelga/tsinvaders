...
function preload(): void  {
  ...
  const assetsPath: String = "assets/cps/png/";
...
class State {
  ...
  private setupOSD(): void {
    ...
    this.scoreOSD = game.add.text(100, 100, "Score: " + this.score, { font: "34px Arial", fill: "#698e00" });
    ...
    this.timerOSD = game.add.text(game.width - 150, 100, this.clock(this.timeUp), { font: "34px Arial", fill: "#698e00" });
